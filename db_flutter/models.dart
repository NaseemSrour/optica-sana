...
class GlassesTest {
  ...
  factory GlassesTest.fromMap(Map<String, dynamic> map) {
    return GlassesTest(
      ...
      lensesDiameterDecentrationHorizontal: map['lenses_diameter_decentration_horizontal'],
      lensesDiameterDecentrationVertical: map['lenses_diameter_decentration_vertical'],
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'lenses_diameter_decentration_horizontal': lensesDiameterDecentrationHorizontal,
      'lenses_diameter_decentration_vertical': lensesDiameterDecentrationVertical,
...
class ContactLensesTest {
  ...
  DateTime examDate; // ISO date string // When FETCHED from DB, it is a String here in the ContactLensesTest object!
  String? examiner;
