...
class CustomerService {
  ...
  */
  ...
  Future<List<ContactLensesTest>> getContactLensesHistory(int customerId) async {
    await _validateCustomerExists(customerId);
  ...
  void _validateInputCustomer(Customer customer) {
    ...
    if (customer.telMobile != null && (customer.telMobile!.length != 10 || int.tryParse(customer.telMobile!) == null)) {
  ...
  Future<void> _validateInputGlassesTest(GlassesTest test) async {
    ...
    if(test.exam_date == null || test.exam_date!.isEmpty) {
    ...
    } else if (test.rLensAxis == null || test.rLensAxis! < 0 || test.rLensAxis! > 180) {
    ...
    } else if (test.lLensAxis == null || test.lLensAxis! < 0 || test.lLensAxis! > 180) {
