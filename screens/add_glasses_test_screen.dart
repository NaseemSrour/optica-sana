...
class AddGlassesTestScreen extends StatefulWidget {
  ...
  const AddGlassesTestScreen({Key? key, required this.customer, required this.customerService}) : super(key: key);
...
class _AddGlassesTestScreenState extends State<AddGlassesTestScreen> {
  ...
  void initState() {
    ...
    final sampleTest = GlassesTest(customerId: widget.customer.id!, examDate: DateTime.now());
  ...
  Future<void> _saveTest() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final newTest = GlassesTest.fromMap(newMap.map((key, value) {
          if (value is String) {
